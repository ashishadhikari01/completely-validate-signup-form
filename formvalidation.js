...
let submitdefault2;
    ...
    // } 
        ...
        passwordErr.textContent = "Filled";
        // submitdefault=true
    }
    ...
    if (confirmPassword.value === "") {
        ...
        confirmPasswordErr.textContent = "Filled";
        // submitdefault=true
    } else {
    ...
    if(submitdefault==true &&submitdefault2==true){
        // myForm.button()
        window.location.href = "formgetsubmitted.html";
        // console.log("sdsd");
    }else{
        alert("form submitted not succesfully");
